...
# En la clase DatabaseManager
    ...
    def save_master_lists(self, empresas, instituciones, documentos_maestros,
        ...
        """
        try:
            docs_to_save = [d.to_dict() for d in documentos_maestros]
        ...
        # DOCUMENTOS
            ...
            for d in docs_to_save:
                if d.get('empresa_nombre') is None:
                    d['empresa_nombre'] = ''  # normalizes
            ...
            self._save_master_table(
                ...
                columns=['nombre', 'rnc', 'rpe', 'representante'], # <-- CAMPOS ACTUALIZADOS
                unique_cols=['nombre'],
